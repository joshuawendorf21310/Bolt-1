...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Next-generation unified emergency operations platform"},{"name":"theme-color","content":"#FF6B00"}],"link":[],"style":[],"script":[],"noscript":[],"title":"FusionEMS Quantum"};
