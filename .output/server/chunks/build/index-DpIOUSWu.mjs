...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const activeIncidents = computed(() => {
      var _a;
      return ((_a = incidents.value) == null ? void 0 : _a.filter((i) => i.status !== "cleared").length) || 0;
    });
    const filteredIncidents = computed(() => {
      var _a;
      if (filterStatus.value === "all") return incidents.value || [];
      return ((_a = incidents.value) == null ? void 0 : _a.filter((i) => i.status === filterStatus.value)) || [];
    });
    const apparatusStats = computed(() => {
      ...
      (_a = apparatus.value) == null ? void 0 : _a.forEach((app) => {
    ...
    const onDutyPersonnel = computed(() => {
      var _a;
      return ((_a = personnel.value) == null ? void 0 : _a.filter((p) => p.is_active).slice(0, 8)) || [];
    });
    const stationStatuses = computed(() => {
      return stations.value || [];
    });
    function formatIncidentType(type) {
      return (type == null ? void 0 : type.replace(/_/g, " ").toUpperCase()) || "UNKNOWN";
    }
    ...
    function getIncidentCommander(id) {
      ...
      const person = (_a = personnel.value) == null ? void 0 : _a.find((p) => p.id === id);
...
//# sourceMappingURL=index-DpIOUSWu.mjs.map
