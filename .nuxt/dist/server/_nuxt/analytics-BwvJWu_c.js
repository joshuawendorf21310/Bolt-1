...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div></div></div></div><div class="reports-section" data-v-a785acc9><h2 data-v-a785acc9>Quick Reports</h2><div class="reports-grid" data-v-a785acc9><div class="report-card" data-v-a785acc9><div class="report-icon" data-v-a785acc9>📋</div><h3 data-v-a785acc9>Staffing Report</h3><p data-v-a785acc9>Complete breakdown of current staffing levels and coverage</p><button class="btn-report" data-v-a785acc9>Generate</button></div><div class="report-card" data-v-a785acc9><div class="report-icon" data-v-a785acc9>💰</div><h3 data-v-a785acc9>Payroll Report</h3><p data-v-a785acc9>Hours worked, overtime, and estimated labor costs</p><button class="btn-report" data-v-a785acc9>Generate</button></div><div class="report-card" data-v-a785acc9><div class="report-icon" data-v-a785acc9>🔄</div><h3 data-v-a785acc9>Shift Changes Report</h3><p data-v-a785acc9>All trades, swaps, and schedule modifications</p><button class="btn-report" data-v-a785acc9>Generate</button></div><div class="report-card" data-v-a785acc9><div class="report-icon" data-v-a785acc9>⚠️</div><h3 data-v-a785acc9>Compliance Report</h3><p data-v-a785acc9>Fatigue violations, overtime limits, and regulatory compliance</p><button class="btn-report" data-v-a785acc9>Generate</button></div><div class="report-card" data-v-a785acc9><div class="report-icon" data-v-a785acc9>📊</div><h3 data-v-a785acc9>Performance Report</h3><p data-v-a785acc9>Individual and team performance metrics</p><button class="btn-report" data-v-a785acc9>Generate</button></div><div class="report-card" data-v-a785acc9><div class="report-icon" data-v-a785acc9>📈</div><h3 data-v-a785acc9>Trends Analysis</h3><p data-v-a785acc9>Historical data and predictive insights</p><button class="btn-report" data-v-a785acc9>Generate</button></div></div></div></div>`);
    };
  }
});
...
//# sourceMappingURL=analytics-BwvJWu_c.js.map
