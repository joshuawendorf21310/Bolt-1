...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="grid grid-cols-4 gap-6 mb-6"><div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6"><div class="flex items-center justify-between"><div><p class="text-sm text-gray-600">Total Claims</p><p class="text-2xl font-bold text-gray-900 mt-1">${ssrInterpolate(stats.totalClaims)}</p></div><div class="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center"><span class="text-2xl">\u{1F4C4}</span></div></div></div><div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6"><div class="flex items-center justify-between"><div><p class="text-sm text-gray-600">Total Billed</p><p class="text-2xl font-bold text-gray-900 mt-1">$${ssrInterpolate(stats.totalBilled.toLocaleString())}</p></div><div class="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center"><span class="text-2xl">\u{1F4B0}</span></div></div></div><div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6"><div class="flex items-center justify-between"><div><p class="text-sm text-gray-600">Total Paid</p><p class="text-2xl font-bold text-green-600 mt-1">$${ssrInterpolate(stats.totalPaid.toLocaleString())}</p></div><div class="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center"><span class="text-2xl">\u2705</span></div></div></div><div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6"><div class="flex items-center justify-between"><div><p class="text-sm text-gray-600">Outstanding</p><p class="text-2xl font-bold text-orange-600 mt-1">$${ssrInterpolate(stats.outstanding.toLocaleString())}</p></div><div class="w-12 h-12 bg-orange-100 rounded-lg flex items-center justify-center"><span class="text-2xl">\u23F3</span></div></div></div></div><div class="bg-white rounded-lg shadow-sm border border-gray-200"><div class="p-6 border-b border-gray-200"><h2 class="text-lg font-semibold text-gray-900">Claims List</h2></div>`);
      if (loading.value) {
        ...
        ssrRenderList(claims.value, (claim) => {
          var _a;
          _push(`<tr class="hover:bg-gray-50"><td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">${ssrInterpolate(claim.claim_number)}</td><td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">${ssrInterpolate(claim.patients.last_name)}, ${ssrInterpolate(claim.patients.first_name)}</td><td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">${ssrInterpolate(formatDate(claim.service_date))}</td><td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">${ssrInterpolate(((_a = claim.payers) == null ? void 0 : _a.name) || "N/A")}</td><td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"> $${ssrInterpolate(claim.total_charge.toFixed(2))}</td><td class="px-6 py-4 whitespace-nowrap"><span class="${ssrRenderClass([
...
//# sourceMappingURL=index-oGu0TUqi.mjs.map
