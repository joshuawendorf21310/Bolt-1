...
import { ref, defineComponent, watch, mergeProps, unref, useSSRContext, computed, withCtx, createVNode, openBlock, createBlock, createCommentVNode, withDirectives, isRef, vModelSelect, Fragment, renderList, toDisplayString, Teleport, withModifiers, vModelText } from "vue";
import { ssrRenderAttrs, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderList, ssrRenderAttr, ssrInterpolate, ssrRenderClass, ssrRenderComponent, ssrRenderTeleport } from "vue/server-renderer";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(currentChannel)) {
        ...
        if (unref(currentChannel).current_speaker_id) {
          _push(`<div class="active-speaker" data-v-97f6cf20><div class="speaker-indicator pulsing" data-v-97f6cf20></div><span data-v-97f6cf20>${ssrInterpolate(unref(currentChannel).current_speaker?.full_name || "Unknown")} is speaking...</span></div>`);
      ...
      ssrRenderList(unref(myTalkGroups), (group) => {
        ...
        if (group.channel?.current_speaker_id) {
              ...
              if (unref(selectedIncident)) {
                ...
                if (unref(assignedUnits).length === 0) {
                  ...
                  ssrRenderList(unref(assignedUnits), (dispatch) => {
                    _push2(`<div class="unit-assignment" data-v-1aefa167${_scopeId}><div class="unit-info" data-v-1aefa167${_scopeId}><span class="unit-number" data-v-1aefa167${_scopeId}>${ssrInterpolate(dispatch.unit?.unit_number)}</span><span class="badge badge-info" data-v-1aefa167${_scopeId}>${ssrInterpolate(dispatch.status)}</span></div><div class="unit-times" data-v-1aefa167${_scopeId}>`);
            ...
            ssrRenderTeleport(_push2, (_push3) => {
              ...
              if (unref(showDispatchModal)) {
                ...
                ssrRenderList(unref(availableUnits), (unit) => {
                  _push3(`<option${ssrRenderAttr("value", unit.id)} data-v-1aefa167${ssrIncludeBooleanAttr(Array.isArray(unref(dispatchData).unit_id) ? ssrLooseContain(unref(dispatchData).unit_id, unit.id) : ssrLooseEqual(unref(dispatchData).unit_id, unit.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(unit.unit_number)} - ${ssrInterpolate(unit.unit_type?.name)} (${ssrInterpolate(unit.status)}) </option>`);
                });
                    ...
                    unref(loading) ? (openBlock(), createBlock("div", {
                      ...
                      (openBlock(true), createBlock(Fragment, null, renderList(unref(filteredIncidents), (incident) => {
                        return openBlock(), createBlock("div", {
                          key: incident.id,
                          class: ["incident-card", { selected: unref(selectedIncident)?.id === incident.id }],
                          ...
                          createVNode("div", { class: "incident-location" }, "📍 " + toDisplayString(incident.location_address), 1),
                          createVNode("div", { class: "incident-time" }, "🕐 " + toDisplayString(formatTime(incident.created_at)), 1),
                          ...
                          (openBlock(true), createBlock(Fragment, null, renderList(unref(assignedUnits), (dispatch) => {
                            return openBlock(), createBlock("div", {
                              ...
                              createVNode("div", { class: "unit-info" }, [
                                createVNode("span", { class: "unit-number" }, toDisplayString(dispatch.unit?.unit_number), 1),
                          ...
                          withDirectives(createVNode("select", {
                            ...
                            (openBlock(true), createBlock(Fragment, null, renderList(unref(availableUnits), (unit) => {
                              return openBlock(), createBlock("option", {
                                key: unit.id,
                                value: unit.id
                              }, toDisplayString(unit.unit_number) + " - " + toDisplayString(unit.unit_type?.name) + " (" + toDisplayString(unit.status) + ") ", 9, ["value"]);
                            }), 128))
                          ], 8, ["onUpdate:modelValue"]), [
...
//# sourceMappingURL=index-CPSxt-wb.js.map
