...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "timeoff-container" }, _attrs))} data-v-9249964b><div class="page-header" data-v-9249964b><div class="header-content" data-v-9249964b><h1 data-v-9249964b>Time-Off Management</h1><p class="subtitle" data-v-9249964b>Request and manage time off for your team</p></div><button class="btn-primary" data-v-9249964b><span class="icon" data-v-9249964b>+</span> New Request </button></div><div class="timeoff-stats" data-v-9249964b><div class="balance-card" data-v-9249964b><div class="balance-header" data-v-9249964b><span class="balance-icon" data-v-9249964b>🏖️</span><span class="balance-type" data-v-9249964b>Vacation</span></div><div class="balance-details" data-v-9249964b><div class="balance-main" data-v-9249964b><span class="balance-value" data-v-9249964b>${ssrInterpolate(unref(myBalance).vacation.available - unref(myBalance).vacation.used)}</span><span class="balance-label" data-v-9249964b>hours available</span></div><div class="balance-secondary" data-v-9249964b><div class="balance-item" data-v-9249964b><span class="label" data-v-9249964b>Used:</span><span class="value" data-v-9249964b>${ssrInterpolate(unref(myBalance).vacation.used)}h</span></div><div class="balance-item" data-v-9249964b><span class="label" data-v-9249964b>Pending:</span><span class="value" data-v-9249964b>${ssrInterpolate(unref(myBalance).vacation.pending)}h</span></div></div></div></div><div class="balance-card" data-v-9249964b><div class="balance-header" data-v-9249964b><span class="balance-icon" data-v-9249964b>🤒</span><span class="balance-type" data-v-9249964b>Sick Leave</span></div><div class="balance-details" data-v-9249964b><div class="balance-main" data-v-9249964b><span class="balance-value" data-v-9249964b>${ssrInterpolate(unref(myBalance).sick.available - unref(myBalance).sick.used)}</span><span class="balance-label" data-v-9249964b>hours available</span></div><div class="balance-secondary" data-v-9249964b><div class="balance-item" data-v-9249964b><span class="label" data-v-9249964b>Used:</span><span class="value" data-v-9249964b>${ssrInterpolate(unref(myBalance).sick.used)}h</span></div><div class="balance-item" data-v-9249964b><span class="label" data-v-9249964b>Pending:</span><span class="value" data-v-9249964b>${ssrInterpolate(unref(myBalance).sick.pending)}h</span></div></div></div></div><div class="balance-card" data-v-9249964b><div class="balance-header" data-v-9249964b><span class="balance-icon" data-v-9249964b>📅</span><span class="balance-type" data-v-9249964b>Personal</span></div><div class="balance-details" data-v-9249964b><div class="balance-main" data-v-9249964b><span class="balance-value" data-v-9249964b>${ssrInterpolate(unref(myBalance).personal.available - unref(myBalance).personal.used)}</span><span class="balance-label" data-v-9249964b>hours available</span></div><div class="balance-secondary" data-v-9249964b><div class="balance-item" data-v-9249964b><span class="label" data-v-9249964b>Used:</span><span class="value" data-v-9249964b>${ssrInterpolate(unref(myBalance).personal.used)}h</span></div><div class="balance-item" data-v-9249964b><span class="label" data-v-9249964b>Pending:</span><span class="value" data-v-9249964b>${ssrInterpolate(unref(myBalance).personal.pending)}h</span></div></div></div></div></div><div class="timeoff-tabs" data-v-9249964b><!--[-->`);
      ...
      if (unref(currentTab) === "my-requests") {
        ...
        if (unref(filteredMyRequests).length === 0) {
          _push(`<div class="empty-state" data-v-9249964b><div class="empty-icon" data-v-9249964b>📝</div><h3 data-v-9249964b>No Requests Found</h3><p data-v-9249964b>You haven&#39;t submitted any time-off requests yet.</p><button class="btn-primary" data-v-9249964b> Create Your First Request </button></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
        ...
        ssrRenderList(unref(calendarDays), (day) => {
          ...
          ssrRenderList(day.timeOffRequests.slice(0, 2), (request) => {
            _push(`<div class="${ssrRenderClass(["timeoff-indicator", `type-${request.request_type}`])}"${ssrRenderAttr("title", `${request.user?.full_name} - ${request.request_type}`)} data-v-9249964b>${ssrInterpolate(request.user?.full_name?.split(" ")[0])}</div>`);
          });
          _push(`<!--]-->`);
...
//# sourceMappingURL=time-off-42zJxpdd.js.map
