import { defineComponent, ref, computed, unref, useSSRContext, mergeProps, watch } from "vue";
import { ssrRenderList, ssrInterpolate, ssrRenderClass, ssrRenderAttrs, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderStyle, ssrRenderComponent } from "vue/server-renderer";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(hasFailures)) {
        ...
        ssrRenderList(unref(degradedComponents), (component) => {
          ...
          _push(`</div><button class="dismiss-btn" data-v-89181e50>×</button></div>`);
        });
        _push(`<!--]--></div></div>`);
      } else {
        _push(`<!---->`);
      ...
      if (unref(showStatusPanel)) {
        _push(`<div class="status-panel" data-v-89181e50><div class="panel-header" data-v-89181e50><h3 data-v-89181e50>System Status</h3><button class="close-btn" data-v-89181e50>×</button></div><div class="status-list" data-v-89181e50><!--[-->`);
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(settings).dnd_enabled) {
        _push(`<div class="dnd-indicator" data-v-23bd3f04> 🌙 Do Not Disturb </div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const useBillingWorkspace = () => {
  ...
  const getAICalls = async (filters) => {
    ...
    if (filters?.escalationRequired !== void 0) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        ssrRenderList(unref(documents), (doc) => {
          ...
          if (doc.is_finalized) {
            _push(`<span class="doc-finalized" data-v-fce11ada>🔒 Finalized</span>`);
          } else {
            _push(`<!---->`);
          }
      ...
      if (unref(activeQueue) === "voicemails") {
        ...
        if (unref(voicemailsQueue).length === 0) {
          ...
          ssrRenderList(unref(voicemailsQueue), (item) => {
            _push(`<div class="queue-item" data-v-cfc73b57><div class="item-header" data-v-cfc73b57><span class="item-icon" data-v-cfc73b57>📨</span><span class="${ssrRenderClass(["item-state", item.queue_state])}" data-v-cfc73b57>${ssrInterpolate(item.queue_state)}</span></div><div class="item-details" data-v-cfc73b57><p class="item-title" data-v-cfc73b57>${ssrInterpolate(item.caller_identity || item.voicemail_records?.caller_number)}</p><p class="item-meta" data-v-cfc73b57>${ssrInterpolate(item.voicemail_records?.duration_seconds)}s • ${ssrInterpolate(formatTime(item.entered_queue_at))}</p></div><div class="item-actions" data-v-cfc73b57>`);
      ...
      if (unref(loading)) {
        ...
        if (unref(reconciliation)) {
          ...
          if (unref(reconciliation).missed_deadlines > 0) {
            _push(`<div class="issue-item critical" data-v-f6d8b7da><span class="issue-icon" data-v-f6d8b7da>🚨</span><div class="issue-content" data-v-f6d8b7da><h4 data-v-f6d8b7da>Hard SLA Breaches</h4><p data-v-f6d8b7da>${ssrInterpolate(unref(reconciliation).missed_deadlines)} items have missed hard deadlines</p></div><button class="view-btn" data-v-f6d8b7da>View</button></div>`);
          } else {
            _push(`<!---->`);
          }
          ...
          if (unref(reconciliation).unlinked_calls > 0) {
            _push(`<div class="issue-item" data-v-f6d8b7da><span class="issue-icon" data-v-f6d8b7da>📞</span><div class="issue-content" data-v-f6d8b7da><h4 data-v-f6d8b7da>Unlinked Calls</h4><p data-v-f6d8b7da>${ssrInterpolate(unref(reconciliation).unlinked_calls)} calls not linked to billing records</p></div><button class="view-btn" data-v-f6d8b7da>View</button></div>`);
          } else {
            _push(`<!---->`);
          }
          if (unref(reconciliation).blocking_documents > 0) {
            _push(`<div class="issue-item" data-v-f6d8b7da><span class="issue-icon" data-v-f6d8b7da>📄</span><div class="issue-content" data-v-f6d8b7da><h4 data-v-f6d8b7da>Blocking Documents</h4><p data-v-f6d8b7da>${ssrInterpolate(unref(reconciliation).blocking_documents)} documents are blocking billing</p></div><button class="view-btn" data-v-f6d8b7da>View</button></div>`);
          } else {
            _push(`<!---->`);
          }
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="workspace-content" data-v-9d657fdd><div class="tab-content" style="${ssrRenderStyle(unref(activeTab) === "overview" ? null : { display: "none" })}" data-v-9d657fdd><div class="overview-section" data-v-9d657fdd><h2 data-v-9d657fdd>Workspace Overview</h2><div class="overview-grid" data-v-9d657fdd><div class="overview-card" data-v-9d657fdd><div class="card-icon" data-v-9d657fdd>📧</div><div class="card-content" data-v-9d657fdd><h3 data-v-9d657fdd>Email Communications</h3><p data-v-9d657fdd>${ssrInterpolate(unref(dashboard).totalEmails)} total emails</p><p data-v-9d657fdd>${ssrInterpolate(unref(dashboard).unreadEmails)} unread</p></div></div><div class="overview-card" data-v-9d657fdd><div class="card-icon" data-v-9d657fdd>📞</div><div class="card-content" data-v-9d657fdd><h3 data-v-9d657fdd>AI Phone Calls</h3><p data-v-9d657fdd>${ssrInterpolate(unref(dashboard).totalCalls)} total calls</p><p data-v-9d657fdd>${ssrInterpolate(unref(dashboard).pendingCalls)} pending review</p><p data-v-9d657fdd>${ssrInterpolate(unref(dashboard).escalatedCalls)} escalated</p></div></div><div class="overview-card" data-v-9d657fdd><div class="card-icon" data-v-9d657fdd>📠</div><div class="card-content" data-v-9d657fdd><h3 data-v-9d657fdd>Fax Communications</h3><p data-v-9d657fdd>${ssrInterpolate(unref(dashboard).totalFaxes)} total faxes</p><p data-v-9d657fdd>${ssrInterpolate(unref(dashboard).pendingFaxes)} pending</p></div></div><div class="overview-card" data-v-9d657fdd><div class="card-icon" data-v-9d657fdd>📄</div><div class="card-content" data-v-9d657fdd><h3 data-v-9d657fdd>Documents</h3><p data-v-9d657fdd>${ssrInterpolate(unref(dashboard).totalDocuments)} total documents</p><p data-v-9d657fdd>${ssrInterpolate(unref(dashboard).draftDocuments)} drafts</p></div></div></div><div class="recent-activity" data-v-9d657fdd><h3 data-v-9d657fdd>Recent Activity</h3>`);
...
export {
  billingWorkspace as default
};
//# sourceMappingURL=billing-workspace-KAh393-4.js.map
