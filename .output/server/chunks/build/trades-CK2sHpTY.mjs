  ...
  setup(__props) {
    ...
    const filteredMarketplaceTrades = computed(() => {
      return marketplaceTrades.value.filter((trade) => {
        ...
        if (filterStation.value && ((_a = trade.offering_shift) == null ? void 0 : _a.station) !== filterStation.value) return false;
        return true;
      });
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(currentTab) === "marketplace") {
        ...
        ssrRenderList(unref(filteredMarketplaceTrades), (trade) => {
          ...
          _push(`<div class="trade-card" data-v-be42500f><div class="trade-header" data-v-be42500f><div class="${ssrRenderClass([`type-${trade.trade_type}`, "trade-type-badge"])}" data-v-be42500f>${ssrInterpolate(trade.trade_type)}</div><div class="trade-date" data-v-be42500f>${ssrInterpolate(formatDate((_a2 = trade.offering_shift) == null ? void 0 : _a2.shift_date))}</div></div><div class="trade-shift-info" data-v-be42500f><div class="shift-detail" data-v-be42500f><span class="detail-label" data-v-be42500f>Offering:</span><div class="shift-block" style="${ssrRenderStyle({ backgroundColor: ((_c2 = (_b2 = trade.offering_shift) == null ? void 0 : _b2.template) == null ? void 0 : _c2.color_code) || "#ff6b00" })}" data-v-be42500f><span class="shift-name" data-v-be42500f>${ssrInterpolate(((_e2 = (_d2 = trade.offering_shift) == null ? void 0 : _d2.template) == null ? void 0 : _e2.template_name) || "Shift")}</span><span class="shift-time" data-v-be42500f>${ssrInterpolate(formatShiftTime(trade.offering_shift))}</span><span class="shift-station" data-v-be42500f>${ssrInterpolate(((_f2 = trade.offering_shift) == null ? void 0 : _f2.station) || "No Station")}</span></div></div><div class="shift-separator" data-v-be42500f>\u21C4</div>`);
          ...
          _push(`</div>`);
          if (trade.reason) {
            _push(`<div class="trade-reason" data-v-be42500f><span class="reason-icon" data-v-be42500f>\u{1F4AC}</span><span class="reason-text" data-v-be42500f>${ssrInterpolate(trade.reason)}</span></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div class="trade-footer" data-v-be42500f><div class="trade-user" data-v-be42500f><span class="user-avatar" data-v-be42500f>${ssrInterpolate(getInitials((_g2 = trade.offering_user) == null ? void 0 : _g2.full_name))}</span><span class="user-name" data-v-be42500f>${ssrInterpolate((_h = trade.offering_user) == null ? void 0 : _h.full_name)}</span></div>`);
          if (!isMyTrade(trade)) {
        ...
        if (unref(filteredMarketplaceTrades).length === 0) {
          _push(`<div class="empty-state" data-v-be42500f><div class="empty-icon" data-v-be42500f>\u{1F504}</div><h3 data-v-be42500f>No Available Trades</h3><p data-v-be42500f>There are no shifts available for trading right now.</p><button class="btn-primary" data-v-be42500f> Offer a Shift </button></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
        ...
        if (unref(myTrades).length === 0) {
          _push(`<div class="empty-state" data-v-be42500f><div class="empty-icon" data-v-be42500f>\u{1F4CB}</div><h3 data-v-be42500f>No Active Trades</h3><p data-v-be42500f>You don&#39;t have any shift trades in progress.</p></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      if (unref(showAcceptModal)) {
        _push(`<div class="modal-overlay" data-v-be42500f><div class="modal-content" data-v-be42500f><div class="modal-header" data-v-be42500f><h2 data-v-be42500f>Accept Trade</h2><button class="btn-close" data-v-be42500f>\xD7</button></div><div class="modal-body" data-v-be42500f><div class="accept-summary" data-v-be42500f><h3 data-v-be42500f>You&#39;re accepting this trade:</h3><div class="trade-preview" data-v-be42500f><div class="preview-shift" data-v-be42500f><span class="preview-label" data-v-be42500f>Their Shift:</span><div class="preview-details" data-v-be42500f><span data-v-be42500f>${ssrInterpolate(formatDate((_b = (_a = unref(selectedTrade)) == null ? void 0 : _a.offering_shift) == null ? void 0 : _b.shift_date))}</span><span data-v-be42500f>${ssrInterpolate(formatShiftTime((_c = unref(selectedTrade)) == null ? void 0 : _c.offering_shift))}</span><span data-v-be42500f>${ssrInterpolate((_e = (_d = unref(selectedTrade)) == null ? void 0 : _d.offering_shift) == null ? void 0 : _e.station)}</span></div></div></div></div>`);
        if (((_f = unref(selectedTrade)) == null ? void 0 : _f.trade_type) === "swap") {
...
//# sourceMappingURL=trades-CK2sHpTY.mjs.map
