      ...
      if (unref(selectedInvoice)) {
        ...
        if (unref(invoiceDetails).lineItems.length > 0) {
          ...
          ssrRenderList(unref(invoiceDetails).lineItems, (item) => {
            _push(`<div class="line-item" data-v-9037f528><div class="item-desc" data-v-9037f528><span class="item-title" data-v-9037f528>${ssrInterpolate(item.description)}</span><span class="item-qty" data-v-9037f528>Qty: ${ssrInterpolate(item.quantity)} \xD7 ${ssrInterpolate(formatCurrency(item.unit_price))}</span></div><span class="item-amount" data-v-9037f528>${ssrInterpolate(formatCurrency(item.amount))}</span></div>`);
          });
          _push(`<!--]--></div></div>`);
        } else {
          _push(`<!---->`);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "billing-invoices-page" }, _attrs))} data-v-bbaa833e><div class="page-header" data-v-bbaa833e><h1 data-v-bbaa833e>Platform Invoices</h1><p class="subtitle" data-v-bbaa833e>Monthly platform fees and billable call charges</p></div><div class="pricing-summary" data-v-bbaa833e><div class="pricing-card" data-v-bbaa833e><span class="pricing-icon" data-v-bbaa833e>\u{1F4B3}</span><div class="pricing-info" data-v-bbaa833e><span class="pricing-label" data-v-bbaa833e>Monthly Platform Fee</span><span class="pricing-amount" data-v-bbaa833e>$500.00</span><span class="pricing-desc" data-v-bbaa833e>Base subscription fee</span></div></div><div class="pricing-card" data-v-bbaa833e><span class="pricing-icon" data-v-bbaa833e>\u{1F4DE}</span><div class="pricing-info" data-v-bbaa833e><span class="pricing-label" data-v-bbaa833e>Per-Billable-Call Fee</span><span class="pricing-amount" data-v-bbaa833e>$45.00</span><span class="pricing-desc" data-v-bbaa833e>Per encounter charge</span></div></div></div><div class="invoice-section" data-v-bbaa833e>`);
...
//# sourceMappingURL=invoices-DH_HfHqj.mjs.map
